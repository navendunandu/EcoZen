                ...
                <div class="navbar-nav ms-auto p-4 p-lg-0">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu m-0">
                            <a href="UserReg.php" class="dropdown-item">User </a>
                            <a href="SellerReg.php" class="dropdown-item">Farmer </a>
                            <a href="DelReg.php" class="dropdown-item">Delivery Agent </a>
                            <a href="AdminReg.php" class="dropdown-item">Admin </a>
                        </div>
                    </div>
