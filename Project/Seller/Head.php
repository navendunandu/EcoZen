                ...
                <div class="navbar-nav ms-auto p-4 p-lg-0">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu m-0">
                            <a href="NewUser.php" class="dropdown-item">Add Daily</a>
                            <a href="SellerReg.php" class="dropdown-item">Daily Statement</a>
                            <a href="DelReg.php" class="dropdown-item">Daily Graph</a>
                        </div>
                    </div>
                    <div class="nav-item dropdown">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu m-0">
                           ...
                           <!-- <a href="DelReg.php" class="dropdown-item">Logout</a>-->
                        </div>
                    </div>
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">Settings</a>
                        <div class="dropdown-menu m-0">
                            <!--<a href="NewUser.php" class="dropdown-item">Account</a>-->
