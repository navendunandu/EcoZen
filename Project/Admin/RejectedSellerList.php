...
<head>
    ...
    <style>
        ...
        th, td {
            ...
            text-align: center;
            font-size: 14px; /* Increased font size for clarity */
...
<h2 align="center"><u>Rejected seller list</u></h2>
...
<tr>
 ...
 $selQry="select * from tbl_seller s inner join tbl_place p on s.place_id=p.place_id inner join tbl_district d
 on d.district_id=p.district_id where seller_status='2'";
